...
type Tab = 'themes' | 'look' | 'sound' | 'game';
    ...
    <div className="screen">
      ...
      <div className="screen__body">
        {tab === 'themes' && (
          <section className="settings-section">
            <p className="settings-hint">
              Pick a vibe — it sets the colours, font, animation, and sounds together.
              Fine-tune any of them in the other tabs.
            </p>
            <ThemePresetPicker />
          </section>
        )}
        ...
        {tab === 'look' && (
          <>
            <section className="settings-section">
              <h2 className="settings-section__title">Colour theme</h2>
                ...
                {THEMES.map((t) => (
                  ...
                  >
                    <span className="theme-swatch__preview" style={{ background: t.swatch[0] }}>
                      <span className="theme-swatch__dot" style={{ background: t.swatch[1] }} />
                    </span>
            ...
            <section className="settings-section">
              ...
              <div className="font-grid">
                {FONTS.map((f) => (
                  ...
                  >
                    <span className="font-option__preview" style={{ fontFamily: f.stack }} aria-hidden="true">
                      123
                    </span>
